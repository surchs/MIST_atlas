...
addpath(genpath('/home/surchs/quarantine/niak-0.12.19'))
...
files_in = niak_grab_region_growing('/gs/scratch/surchs/cambridge');
...
opt.folder_out = '/gs/scratch/surchs/cambridge/out'; % Where to store the results
...
opt.scales_maps = [10     7     7;
		   ...
		   200   200   197;
		   320   320   325;
		   440   484   444]; % The scales that will be used to generate the maps of brain clusters and stability. 
...
opt.psom.max_queued = 50; % Uncomment and change this parameter to set the number of parallel threads used to run the pipeline
